...
#define P_GEN_2_CROSS_EVOS               TRUE // Generation 2 additions to Generation 1 families.
#define P_GEN_3_CROSS_EVOS               TRUE // Keep Azurill and Wynaut.
#define P_GEN_4_CROSS_EVOS               TRUE // Keep selected evolutions and baby Pokémon tied to Generations 1 and 2.
//#define P_GEN_5_CROSS_EVOS             // Gen 5 didn't introduce any cross-gen evos.
#define P_GEN_6_CROSS_EVOS               TRUE // Keep Sylveon.
//#define P_GEN_7_CROSS_EVOS             // Alolan evolutions handled by P_ALOLAN_FORMS.
#define P_GEN_8_CROSS_EVOS               FALSE // Exclude Kleavor, Ursaluna, and Wyrdeer.
#define P_GEN_9_CROSS_EVOS               TRUE // Keep Annihilape, Dudunsparce, and Farigiraf.
